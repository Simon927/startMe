 ...
 */
@property (nonatomic, retain) UIFont *fontLink;
...
/**
 ...
 @warning You must specify a value for this parameter before `setText:`
 */
@property (nonatomic, retain) UIFont *fontHashtag;
...
/**
 ...
 @warning You must specify a value for this parameter before `setText:`
 */
@property (nonatomic, retain) UIColor *colorLink;
...
/**
 ...
 @warning You must specify a value for this parameter before `setText:`
 */
@property (nonatomic, retain) UIColor *colorHashtag;
 ...
 */
@property (nonatomic, retain) id<STLinkProtocol> delegate __attribute__ ((deprecated));
